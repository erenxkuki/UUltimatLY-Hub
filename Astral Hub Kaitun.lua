...
getgenv().Configs = {
    ...
    FPS Booster = true,          -- Disable effects / shadows for performance
...
getgenv().Configs.AutoSea2Quest = false          -- toggle this to enable

task.spawn(function()
    while task.wait(0.5) do
        local cfg = getgenv().Configs.AutoSea2Quest
        ...
        pcall(function()
            ...
            if Workspace.Map:FindFirstChild("Dressrosa") then
                getgenv().Configs.AutoSea2Quest = false
                return
            end
...
getgenv().Configs = getgenv().Configs or {}
getgenv().Configs.AutoSea3Quest = false          -- toggle this to enable

task.spawn(function()
    while task.wait(0.5) do
        local cfg = getgenv().Configs.AutoSea3Quest
        if not cfg then continue end
        ...
        pcall(function()
            ...
            if repl.Remotes.CommF_:InvokeServer("ZQuestProgress", "Check") == 1 then
                ...
                getgenv().Configs.AutoSea3Quest = false
                task.wait(30)
                return
            end
...
--[[
   ╔══════════════════════════════════════════════════════════════╗
   ║     ASTRAL HUB - Kaitun (PART 6 – REWRITTEN)   ║
...
--[[
   ╔══════════════════════════════════════════════════════════════╗
   ║     ASTRAL HUB - Kaitun (PART 7 – REWRITTEN)   ║
