...
local v15 = v14:CreateWindow({
    Title = "UUltimatLY Hub V3",-- thay tên bạn muốn đặt
    SubTitle = "By realryzu",-- tên bạn
    TabWidth = 160,
    Theme = "Dark",--màu
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=71108055000421";
...
v16.Home:AddButton({
    Title = "UUltimatLY YouTube Channel",
    Description = "Click(Copy)",
    Callback = function()
...
v16.Home:AddButton({
    Title = "Remember:",
    Description = "This the V3 version of UUltimatLY Hub made by realryzu aka [UUltimatLY].",
    Callback = function()
        setclipboard("https://www.roblox.com/users/4886925993/profile");
    end
});
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v616 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "UUltimatLY Hub",
                    Content = "Frozen Dimension Found",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://73642467719097") then --thay id ảnh vào
                    return v729;
                end
            end
        end
