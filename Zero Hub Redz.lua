...
if Settings.Translator == true then
    pcall(function()
        _G.ZeroTranslator = HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/PlockScripts/newredz/refs/heads/main/NewTranslator/NewBloxFruits/NewPortuguese.json"))
    end)
end
...
local vu32 = loadstring(game:HttpGet("https://raw.githubusercontent.com/daucobonhi/UiRedzV5/refs/heads/main/DemoUi.lua"))()
local v466 = vu32:MakeWindow({
    Title = "Zero Hub : Blox Fruits",
    SubTitle = "by nexora.xyz",
    SaveFolder = "Zero Hub | zero lib v5.lua"
})
...
v484:AddDiscordInvite({
    ...
    Description = "Join Zero Hub Discord To Receive Updates",
    Logo = "rbxassetid://131723242350068",
    Invite = "https://discord.gg/BJMsBfDM"
})
    ...
    while task.wait(1) do
        pcall(function()
            if not game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                ...
                v984:Set("Mirage Island Spawned    ")
            end
        end)
    end
end)
...
local _ = v491:AddSection({"Check Fruits On Stock"})
...
v491:AddDropdown({
    ...
    Options = {
        ...
        "Quake","Buddha","Spider","Phoenix","Dough"
    },
    Default = "Flame",
    Callback = function(v)
        _G.SelectChip = v
...
local Islands = {
    ...
    ["Hot And Cold"] = CFrame.new(-6127.654, 15.952, -5040.286),
...
local JUMP_SAVE_FILE = "jumppower_save.txt"
...
v496:AddToggle({
    Name = "Delete Lava",
    Description = "Delete Lave From Everything Which Have Lava",
    Default = false,
...
v496:AddToggle({
    ...
    Description = "PS : That It Will Set Home Point On The Current Island You Are On",
    Value = false,
...
PosY = 30
v496:AddToggle({Title = "Dodge No CD (CoolDown)", Value = false, Callback = function(v1178)
...
print("--[[Hop Server If An Admin Joins Your Server]]--")
