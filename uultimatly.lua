...
l_ImageButton_0.Image = "rbxassetid://80413808181094"
...
local v484 = v466:MakeTab({"Information | Info", "info"})
...
v484:AddDiscordInvite({
    ...
    Logo = "rbxassetid://80413808181094",
    Invite = "https://discord.gg/dtkbvtrM7G"
...
v484:AddDiscordInvite({
    ...
    Description = "YouTube",
    Logo = "rbxassetid://80413808181094",
    Invite = "https://www.youtube.com/@UUltimatLY"
...
v485:AddToggle({
    ...
    Description = "Leveling Up on the New Island",
    Value = false,
...
v485:AddToggle({
    ...
    Description = "Attack Nearby Monsters",
    Default = false,
...
v485:AddToggle({
    ...
    Description = "Auto Move to the Summer Token Location by Sea and Farm Electrified Monsters",
    Default = false,
...
v485:AddToggle({
    Name = "Farm Pirate",
    Description = "Attack Pirates on the Sea Fortress",
    Default = false,
...
v485:AddToggle({
    ...
    Description = "Farm Monsters and Attack the Bird Boss",
    Default = false,
...
v485:AddToggle({
    ...
    Description = "Auto Break the Jar to Summon the Boss",
    Default = false,
...
v494:AddSlider({
    Title = "Running Speed by UUltimatLY",
    Min = 26,
    Max = 300,
...
v494:AddToggle({
    Name = "Delete Lava",
    Description = "Remove Lava to Avoid Those Kids Pushing You Into It :))",
    Default = false,
...
v496:AddToggle({
    Title = "Fruis",
    Description = "Auto Upgrade Fruits Stats",
    Value = false,
